<template>
  <div class="main-header">
    ...
    <div class="d-flex align-items-center">
      ...
      <div class="search-bar md-3 col-md-8 col-lg-8">
        <input type="text" placeholder="Search" v-model="headerSearch" />
        <i class="search-icon text-muted i-Magnifi-Glass1"></i>
      </div>
     ...
     <div class=" mr-3" >
          <i class="i-Calendar text-20 cursor-pointer header-icon d-none d-sm-inline-block" v-b-popover.hover.bottom="'Schedule'"  > </i>
      </div>
      <div class=" mr-3" >
          <i class="i-File-Clipboard-File--Text text-20 cursor-pointer header-icon d-none d-sm-inline-block" v-b-popover.hover.bottom="'Create an Appointment'"  > </i>
      </div>
      <div class="mr-3  " >
